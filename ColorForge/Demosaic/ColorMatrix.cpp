...
// Build Camera → AWG
CamToAWG3Result getCamToAWG3(const libraw_colordata_t& color) {
	...
	M3 M_Cam2XYZ = inverse3x3(M_XYZ2Cam); // your existing invert code
	...
	return { M_Cam_to_AWG365 /*M_Cam_RGB*/, { rMul, gMul, bMul } };
}
